...
export function MoodEnergyChart({ logs }: { logs: Log[] }) {
  ...
  return (
    <View style={{ backgroundColor: '#1F2023', borderWidth: 1, borderColor: '#2A2B2F', borderRadius: 12, padding: 16, marginBottom: 24 }}>
      <Text style={{ color: '#FFFDFC', fontWeight: '600', marginBottom: 16, marginLeft: 8 }}>Mood & Energy (14d)</Text>
